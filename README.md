...
The last command will also show various statistics, including information about outgoing connections. It might be a good idea to log the output of `nft list ruleset` once every day. 
